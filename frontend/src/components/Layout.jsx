        ...
        <div className={`flex-1 min-h-screen min-w-0 overflow-x-hidden transition-all duration-300 ${collapsed ? "md:ml-16" : "md:ml-44"}`}>
          ...
          >
            ...
            <button
              ...
              className={`btn-grad flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 md:px-3 md:py-2 text-xs font-semibold text-white transition-all shrink-0 ${isVoiceOpen ? "mic-ring" : ""}`}
